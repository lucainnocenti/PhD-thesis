...
We presented a novel approach to classify \acp{VVB} using a combination of supervised and unsupervised learning algorithms. We demonstrated how the use of inference strategies based on CNNs, PCA, and SVMs allows to extract efficiently properties of high-dimensional photonics \ac{VVB} systems.
