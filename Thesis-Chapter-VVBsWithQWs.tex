...
\highlight{(includere nuova sezione hyGG blabla)}
...
\begin{figure}[tb]
	...
	\highlight{(aggiornare figura e caption da paper)}
	}
...
\begin{figure}[tb]
    ...
    \caption{
	    ...
	    \highlight{(togliere plot e mettere nuovi risultati (e ficcare github da qualche parte))}
    }%
