...
Not surprisingly, in the past decades there has been a steady interest in engineering quantum states of high dimensions. %, with ongoing investigations spanning various physical platforms. Among the latter, quantum optical systems play a prominent role, where 
...
\section{Quantum Walks background}
%A \ac{DTQW} on a line is a system with two degrees of freedom: a walker degree of freedom, spanning a finite number of steps, and a coin degree of freedom, living in a 2-dimensional Hilbert space.
...
\begin{figure}[ht!]
\includegraphics[width=0.59\columnwidth]{Scheme}
	\caption{
...
\begin{figure}[tb]
	\centering
	\includegraphics[width=\linewidth]{projProbLandscape_2steps_allreal2.pdf}
	\caption{
...
\begin{figure}[tb]
	\centering
	\includegraphics[width=\linewidth]{fidelityVsEpsVaryingD_2steps.pdf}
	\caption{
