...
\begin{example}[label=ex:qw_conditions_few_steps]
    ...
    Let us consider an additional step, with coin $\calC_2=\frac{1}{\sqrt2}(X+Y)$.
    ...
    \begin{aligned}
        ...
        &\bs v''_5 = \frac{\sqrt2}{4}\begin{pmatrix} 1 + i\sqrt2\\ \sqrt2 + i \end{pmatrix},
        &&\bs v''_6 = \frac{\sqrt2}{4}\begin{pmatrix} -i \\ -1 \end{pmatrix},
    \end{aligned}
    \end{equation}
    It is then straightforward to verify that
    $\bs v_1^{\prime\prime\dagger}\bs v_6'' = 0$.
    Furthermore,
    $\bs v_1^{\prime\prime\dagger}\bs v_5'' = 1/4$
    and $\bs v_2^{\prime\prime\dagger}\bs v_6'' = -1/4$,
    thus 
    $\bs v_1^{\prime\prime\dagger}\bs v_5'' + \bs v_2^{\prime\prime\dagger}\bs v_6'' = 0$,
...
The same technique used in the above sections, applied iteratively, leads to the following set of conditions characterising the amplitudes of a $\ket*{\Psi}$ output of $n$ steps:
\begin{equation}
