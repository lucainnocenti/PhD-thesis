...
\begin{equation}
	\ket\Psi =
	\calW_{\calC_{n}} \calW_{\calC_{n-1}} ... \calW_{\calC_{1}}
    \ket{\Psi^{(0)}},
...
\par\highlight{FIX FROM HEREEEE}\par
% \begin{equation}
\begin{gather}
...
\end{equation*}
% \end{equation}
The cases $n=2$ and $n=3$ were explicitly computed in~\cref{sec:qw_reachability},
