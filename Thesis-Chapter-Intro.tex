...
DTQWs are systems comprised of a low-dimensional system (usually a qubit) named \textit{coin}, and a high-dimensional system, named the \textit{walker}.
These names are in direct analogy with classical random walks. A single \textit{step} in a DTQW consists in a unitary evolution $\calW$ applied to the current state of the QW.
...
Alternatively, it is possible to consider CTQWs, which instead 
