...
\tmpHeading{Second quantum revolution}
...
\tmpHeading{Branches of quantum information science}
...
\tmpHeading{State of the art of quantum computing}
...
Parallel to the surge of interest in quantum technologies in recent years, another field of study that has seen an explosion of funding and research interest is \ac{ML}~\cite{you2011atomic,bishop2006pattern,abu2012learning,friedman2001elements,murphy2012machine,mehta2019highbias}.
...
\cite{carleo2019machine}\highlight{and all the other references}

\tmpHeading{What is ``quantum machine learning''?}
In particular, the intersection of \ac{ML} and quantum information science is also currently under intense study, and falls generically under the name of \ac{QML}~\cite{wittek2014quantum,schuld2014introduction,adcock2015advances,biamonte2017quantum,arunachalam2017survey}.
Due to the wide reach of both fields, \ac{QML} inevitably branched out into several different directions of study.
The first applications of the term referred to the study of quantum algorithms to tackle more efficiently tasks that are generally solved using \ac{ML}~\cite{giovannetti2008quantum,harrow2009quantum,lloyd2013quantum,lloyd2014quantum,rebentrost2014quantum,lloyd2016quantum,rebentrost2018quantum,rebentrost2016quantum}, to which a multitude of works followed~\cite{dunjko2017machine,ciliberto2018quantum,schuld2018supervised,wittek2014quantum,schuld2014introduction}. This direction of study is now sometimes referred to as \emph{quantum-enhanced machine learning}, to distinguish it from other subfields of the much-encompassing \ac{QML}.
Another direction of study, more focussed on the theoretical foundations on how quantum mechanics can make the general process of \emph{learning} from data more efficient, is \emph{quantum learning theory}~\cite{arunachalam2017survey}.
...
Yet another field of study falling under the umbrella of \ac{QML} concerns how \emph{classical} \ac{ML} can help find solutions to the many open problems in the field of quantum information science~\cite{carleo2019machine}.
...
\highlight{(paragraph taken from Verona stuff)}
