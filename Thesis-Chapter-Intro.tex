...
Quantum information science~\cite{nielsen2006quantum,watrous2018theory} \cite{watrous2018theory,nielsen2006quantum,nielsen2002simple} studies how information behaves and can be manipulated at the quantum level.
...
Some of the directions that have seen the largest interest we identify the many applications of machine learning for many-body physics, and more generally the use of \emph{neural-network quantum states} as \ansatz to find entangled states etc~\highlight{(refs for Carleo, Melko, Carrasquilla papers. Check out also last paper by Mauro and Alessandro.)}
Also applications to identify phase transitions~\highlight{refs}.
...
In particular, supervised learning techniques were recently demonstrated to solve \emph{gate design} problems~\cite{banchi2016quantum,innocenti2018supervised}\highlight{(add IJQJ paper)}.
